...
namespace pong2
{
    class Program : GameWindow
    {
        ...
        protected override void OnUpdateFrame(FrameEventArgs e) // movimento da bola e players e limites da tela
        {
            // movimento e limitações da bola
            xDaBola = xDaBola + velocidadeDaBolaEmX;
            yDaBola = yDaBola + velocidadeDaBolaEmY;

            if (xDaBola + tamanhoDaBola / 2 > xDoJogador2() - larguraDosJogadores() / 2 && yDaBola - tamanhoDaBola / 2 < yDoJogador2 + alturaDosJogadores() / 2 && yDaBola + tamanhoDaBola / 2 > yDoJogador2 - alturaDosJogadores() / 2)
            {
                velocidadeDaBolaEmX = -velocidadeDaBolaEmX;
            }
            if (xDaBola - tamanhoDaBola / 2 < xDoJogador1() + larguraDosJogadores() / 2 && yDaBola - tamanhoDaBola / 2 < yDoJogador1 + alturaDosJogadores() / 2 && yDaBola + tamanhoDaBola / 2 > yDoJogador1 - alturaDosJogadores() / 2)
            {
                velocidadeDaBolaEmX = -velocidadeDaBolaEmX;
            }
            ...
            //daqui para frente é o movimento
        ...
        protected override void OnRenderFrame(FrameEventArgs e) // desanhar na tela
        {
        ...
        void DesenharRetangulo(int x, int y, int largura, int altura, float r, float g, float b) // void para desenhar e colorir
        {
            GL.Color3(r, g, b);
